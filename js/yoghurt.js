            ...
            function yogurt() {
                ...
                function(rst) {
                    ...
                    for (var i = 0; i < rst.detailInfos.length; i++) {
                        ...
                        li.html('<a href="yogurt2.html?id=' + rst.detailInfos[i].detailId + '"><div class="text_title"><img class="text_title_img" src=' + rst.fileService + "/" + "800x800s" + "/" + rst.detailInfos[i].detailWeedfsId + ' alt="" ><div><p>' + rst.detailInfos[i].detailSubTitle + '</p><p style="font-weight: bold;">' + rst.detailInfos[i].detailTitle + '</p></div><img src="images/箭头.png" alt="" class="text_title_img1" ></div></a><div  class="text_title2">' + rst.detailInfos[i].detailText + '</div>');
